...
public class MpEssentialsComp : VvvvComponent
{

    [Solution("src/mp.essentials/mp.essentials.sln")]
    public Solution Sln;
    ...
    public override void Install(Build build)
    {
        Build.CreateSymlinkOrCopy(
            build.VvvvPath / "packs" / "mp.essentials",
            Sln.Path.Parent / "deploy" / "mp.essentials"
        );
    }
}